 ...
 *
 * @author Rich Marisa <rjm2@cornell.edu>
 *
 * @version 1.0.0
 *
 * @license http://opensource.org/licenses/mit-license.php MIT License
 *
 *   Original author: Roumen Damianoff <roumen@dawebs.com>
 *   Original version: 2.8.1
 *   https://roumen.it/projects/laravel-feed
...
class Feed
{
     ...
     * @param  carbon|datetime|int  $cache (0 - turns off the cache)
     * @return view
     */
    public function render($format = 'atom', $cache = null, $key = null)
    {
        ...
        if ($this->caching > 0) {
            Cache::put($this->cacheKey, View::make('feed::'.$format, ['items' => $this->items, 'channel' => $channel, 'namespaces' => $this->getNamespaces()])->render(), $this->caching);
            ...
            return Response::make(View::make($this->getView($format), $viewData), 200, ['Content-type' => $this->ctype.'; charset='.$this->charset]);
        } elseif ($this->caching < 0) {
